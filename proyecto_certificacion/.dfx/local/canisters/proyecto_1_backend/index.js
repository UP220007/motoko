...
import { idlFactory } from './proyecto_1_backend.did.js';
export { idlFactory } from './proyecto_1_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_PROYECTO_1_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./proyecto_1_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the proyecto_1_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./proyecto_1_backend.did.js")._SERVICE>}
 */
export const proyecto_1_backend = createActor(canisterId);
